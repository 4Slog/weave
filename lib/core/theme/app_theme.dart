...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    sliderTheme: SliderThemeData(
      ...
      overlayColor: kentePurple.withAlpha(51),
      trackHeight: 4,
    ...
    switchTheme: SwitchThemeData(
      ...
      trackColor: WidgetStateProperty.resolveWith<Color>((states) {
        if (states.contains(WidgetState.selected)) {
          return kentePurple.withAlpha(128);
        }
    ...
    chipTheme: ChipThemeData(
      ...
      selectedColor: kentePurple.withAlpha(51),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    chipTheme: ChipThemeData(
      ...
      selectedColor: kentePurple.withAlpha(77),
      secondarySelectedColor: kentePurple,
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
      labelStyle: const TextStyle(
        fontFamily: 'Roboto',
  ...
  static Color getCulturalElementColor(String elementName, {bool darkMode = false}) {
    ...
    switch (elementName.toLowerCase()) {
      ...
      case 'royalty':
      case 'status':
        return darkMode ? kenteGold.withAlpha(204) : kenteGold;
      ...
      default:
        return darkMode ? kentePurple.withAlpha(204) : kentePurple;
    }
  }
}