...
class NarrativeChoiceWidget extends StatefulWidget {
  ...
  @override
  _NarrativeChoiceWidgetState createState() => _NarrativeChoiceWidgetState();
}
            ...
            if (widget.showDifficulty)
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isLocked ? Colors.grey.shade200 : difficultyColor.withOpacity(0.2),
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
...
class DetailedNarrativeChoiceWidget extends StatefulWidget {
  ...
  @override
  _DetailedNarrativeChoiceWidgetState createState() => _DetailedNarrativeChoiceWidgetState();
}
